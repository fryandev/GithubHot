...
| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/celery/celery](https://github.com/celery/celery) |
| ⭐ Stars | 28562 |
| 🍴 Forks | 5068 |
| 👀 Watchers | 28562 |
| 📝 Open Issues | 783 |
...
| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/qdrant/qdrant](https://github.com/qdrant/qdrant) |
| ⭐ Stars | 31853 |
| 🍴 Forks | 2324 |
| 👀 Watchers | 31853 |
| 📝 Open Issues | 568 |
...
**中文简介**：
Qdrant - 面向下一代 AI 的高性能、大规模向量数据库和向量搜索引擎。云版本 also available https://cloud.qdrant.io/
...
**中文Topics**：ai-search, ai-search-engine, embeddings-similarity, hnsw, 混合搜索, 图像搜索, knn-algorithm, 机器学习, mlops, nearest-neighbor-search, 神经网络, neural-search, 推荐系统, 搜索, search-engine, search-engines, 相似性搜索, 向量数据库, 向量搜索, vector-search-engine


---

### 104. angular/components

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/angular/components](https://github.com/angular/components) |
| ⭐ Stars | 25029 |
| 🍴 Forks | 6840 |
| 👀 Watchers | 25029 |
| 📝 Open Issues | 1361 |
...
**中文简介**：
Angular 的组件基础设施和 Material Design 组件


**Topics**：angular, angular-components, material, material-design
...
### 106. surrealdb/surrealdb

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/surrealdb/surrealdb](https://github.com/surrealdb/surrealdb) |
| ⭐ Stars | 32337 |
| 🍴 Forks | 1277 |
| 👀 Watchers | 32337 |
| 📝 Open Issues | 656 |
...
**中文Topics**：backend-as-a-service, 云数据库, 数据库, database-as-a-service, 开发者工具, devtools, 分布式, 分布式数据库, 文档数据库, 图数据库, iot数据库, nosql, 实时数据库, serverless, sql, surreal, surrealdb, web


---

### 107. hiddify/hiddify-app
...
### 108. alibaba/Sentinel

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/alibaba/Sentinel](https://github.com/alibaba/Sentinel) |
| ⭐ Stars | 23119 |
| 🍴 Forks | 8148 |
| 👀 Watchers | 23119 |
| 📝 Open Issues | 851 |
...
**中文简介**：
强大的流量控制组件，可实现微服务的可靠性、弹性和监控。 （面向云原生微服务的高可用流控防护组件）


**Topics**：alibaba, circuit-breaker, cloud-native, java, microservice, microservices, rate-limiting, reliability, resiliency



---

### 109. XIU2/CloudflareSpeedTest
...
### 110. GoogleCloudPlatform/microservices-demo
...
### 112. trailofbits/algo

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/trailofbits/algo](https://github.com/trailofbits/algo) |
| ⭐ Stars | 30260 |
| 🍴 Forks | 2358 |
| 👀 Watchers | 30260 |
| 📝 Open Issues | 74 |
...
**Topics**：ansible, encryption, ikev2, ipsec, security, ssh-tunnel, strongswan, vpn, vpn-client, vpn-server, wireguard



---

### 113. cloudreve/cloudreve
...
### 114. mozilla/DeepSpeech

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/mozilla/DeepSpeech](https://github.com/mozilla/DeepSpeech) |
| ⭐ Stars | 26749 |
| 🍴 Forks | 4088 |
| 👀 Watchers | 26749 |
| 📝 Open Issues | 151 |
...
**中文简介**：
DeepSpeech 是一款开源嵌入式（离线、设备端）语音转文字引擎，可在从树莓派 4 到高性能 GPU 服务器的各种设备上实时运行。
...
**中文Topics**：["deep-learning", "deepspeech", "embedded", "machine-learning", "neural-networks", "offline", "on-device", "speech-recognition", "speech-to-text", "tensorflow"]


---

### 115. PaddlePaddle/Paddle
...
**中文简介**：
PArallel分布式深度学习：来自工业实践的机器学习框架（『飞桨』核心框架，深度学习&机器学习高性能单机、全面训练和跨平台部署）


**Topics**：deep-learning, distributed-training, efficiency, machine-learning, neural-network, paddlepaddle, python, scalability



---

### 116. chroma-core/chroma

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/chroma-core/chroma](https://github.com/chroma-core/chroma) |
| ⭐ Stars | 28242 |
| 🍴 Forks | 2294 |
| 👀 Watchers | 28242 |
| 📝 Open Issues | 641 |
...
### 118. notionnext-org/NotionNext

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/notionnext-org/NotionNext](https://github.com/notionnext-org/NotionNext) |
| ⭐ Stars | 11523 |
| 🍴 Forks | 14641 |
| 👀 Watchers | 11523 |
| 📝 Open Issues | 190 |
...
| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/Netflix/Hystrix](https://github.com/Netflix/Hystrix) |
| ⭐ Stars | 24455 |
| 🍴 Forks | 4697 |
| 👀 Watchers | 24455 |
| 📝 Open Issues | 56 |
...
### 122. jhao104/proxy_pool

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/jhao104/proxy_pool](https://github.com/jhao104/proxy_pool) |
| ⭐ Stars | 23385 |
| 🍴 Forks | 5384 |
| 👀 Watchers | 23385 |
| 📝 Open Issues | 297 |
...
### 123. proxyee-down-org/proxyee-down

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/proxyee-down-org/proxyee-down](https://github.com/proxyee-down-org/proxyee-down) |
| ⭐ Stars | 24732 |
| 🍴 Forks | 4356 |
| 👀 Watchers | 24732 |
| 📝 Open Issues | 214 |
...
### 125. imthenachoman/How-To-Secure-A-Linux-Server
...
### 126. maillab/cloud-mail

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/maillab/cloud-mail](https://github.com/maillab/cloud-mail) |
| ⭐ Stars | 10782 |
| 🍴 Forks | 14511 |
| 👀 Watchers | 10782 |
| 📝 Open Issues | 49 |
...
**中文简介**：
基于 Cloudflare 的电子邮件服务 | 基于Cloudflare的邮箱服务 | Cloudflare 邮箱 邮箱 邮箱
...
| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/QwenLM/Qwen3](https://github.com/QwenLM/Qwen3) |
| ⭐ Stars | 27291 |
| 🍴 Forks | 1991 |
| 👀 Watchers | 27291 |
| 📝 Open Issues | 53 |
...
### 129. Molunerfinn/PicGo

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/Molunerfinn/PicGo](https://github.com/Molunerfinn/PicGo) |
| ⭐ Stars | 26783 |
| 🍴 Forks | 2328 |
| 👀 Watchers | 26783 |
| 📝 Open Issues | 26 |
...
**中文简介**：
🚀 高效创作者的终极图床工具。支持 Obsidian、Typora、VS Code 等，以及 60 多种图床服务（S3、GitHub、Cloudflare R2、Imgur、阿里云 OSS...）。粘贴、上传，搞定。


**Topics**：aliyun-oss, cloudflare-r2, electron, electron-app, electron-vue, github, image, imageuploader, imgur, imgur-uploader, qiniu, s3-uploader, smms, tencent-cos, upyun, vue, weibo

**中文Topics**：["aliyun-oss", "cloudflare-r2", "electron", "electron-app", "electron-vue", "github", "image", "imageuploader", "imgur", "imgur-uploader", "qiniu", "s3-uploader", "smms", "tencent-cos", "upyun", "vue", "weibo"]
...
### 132. OtterMind/Chat2DB

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/OtterMind/Chat2DB](https://github.com/OtterMind/Chat2DB) |
| ⭐ Stars | 25730 |
| 🍴 Forks | 2823 |
| 👀 Watchers | 25730 |
| 📝 Open Issues | 533 |
...
**中文简介**：
AI驱动的数据库工具和SQL客户端，最热门的GUI客户端，支持MySQL、Oracle、PostgreSQL、DB2、SQL Server、DB2、SQLite、H2、ClickHouse等。
...
### 133. kriasoft/react-starter-kit

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/kriasoft/react-starter-kit](https://github.com/kriasoft/react-starter-kit) |
| ⭐ Stars | 23600 |
| 🍴 Forks | 4218 |
| 👀 Watchers | 23600 |
| 📝 Open Issues | 9 |
...
**中文简介**：
现代 React 入门套件，包含 Bun、TypeScript、Tailwind CSS、tRPC、Stripe 和 Cloudflare Workers。用于构建快速 Web 应用程序的生产就绪型 monorepo。


**Topics**：better-auth, boilerplate, bun, cloudflare, cloudflare-workers, drizzle-orm, gcp, hono, neon, nodejs, react, saas, shadcn-ui, starter-kit, tailwindcss, tanstack-router, template, trpc, typescript, vite
...
| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/ente-io/ente](https://github.com/ente-io/ente) |
| ⭐ Stars | 26991 |
| 🍴 Forks | 1640 |
| 👀 Watchers | 26991 |
| 📝 Open Issues | 410 |
...
**中文Topics**：["2fa", "android", "authy", "e2ee", "encryption", "end-to-end-encryption", "flutter", "golang", "google-photos", "google-photos-alternative", "ios", "opensource", "photos", "privacy", "privacy-tools", "typescript", "zero-knowledge"]
...
**中文简介**：
开源、隐私优先的网站分析工具。轻量级、无 Cookie 的 Google Analytics 替代品。支持自托管或云端部署。


**Topics**：analytics, analytics-dashboard, clickhouse, elixir, google-analytics, marketing, open-source-analytics, phoenix, plausible-analytics, postgresql, privacy, privacy-friendly, self-hosted, simple-analytics, statistics, tailwindcss, web-analytics, website-analytics, website-stats, website-tracking

**中文Topics**：["analytics", "analytics-dashboard", "clickhouse", "elixir", "google-analytics", "marketing", "open-source-analytics", "phoenix", "plausible-analytics", "postgresql", "privacy", "privacy-friendly", "self-hosted", "simple-analytics", "statistics", "tailwindcss", "web-analytics", "website-analytics", "website-stats", "website-tracking"]
...
| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/remy/nodemon](https://github.com/remy/nodemon) |
| ⭐ Stars | 26684 |
| 🍴 Forks | 1740 |
| 👀 Watchers | 26684 |
| 📝 Open Issues | 12 |
...
**中文简介**：
监控 node.js 应用的任何变更并自动重启服务器——开发利器


**Topics**：node, nodemon, watch

**中文Topics**：["node", "nodemon", "watch"]
...
| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/anomalyco/sst](https://github.com/anomalyco/sst) |
| ⭐ Stars | 26060 |
| 🍴 Forks | 2098 |
| 👀 Watchers | 26060 |
| 📝 Open Issues | 247 |
...
### 141. forezp/SpringCloudLearning

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/forezp/SpringCloudLearning](https://github.com/forezp/SpringCloudLearning) |
| ⭐ Stars | 17947 |
| 🍴 Forks | 7967 |
| 👀 Watchers | 17947 |
| 📝 Open Issues | 50 |
...
**Topics**：consul, eureka, feign, finchley, gateway, hystrix, hystrix-dashboard, hystrix-turbine, ribbon, sleuth, spring, spring-boot, spring-cloud, springbootadmin, zuul

**中文Topics**：领事, 尤里卡, 假装, 芬奇利, 网关, hystrix, hystrix仪表板, hystrix-涡轮机, 丝带, 侦探, 春天, 弹簧靴, 春云, springboot管理, 祖尔


---

### 142. airbytehq/airbyte

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/airbytehq/airbyte](https://github.com/airbytehq/airbyte) |
| ⭐ Stars | 21395 |
| 🍴 Forks | 5207 |
| 👀 Watchers | 21395 |
| 📝 Open Issues | 2216 |
...
**中文简介**：
ELT 管道和 AI 代理的开源数据移动 - 从 API、数据库和文件到仓库、湖泊和 AI 应用程序。自托管和云。
...
### 143. yudaocode/SpringBoot-Labs

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/yudaocode/SpringBoot-Labs](https://github.com/yudaocode/SpringBoot-Labs) |
| ⭐ Stars | 20100 |
| 🍴 Forks | 6152 |
| 👀 Watchers | 20100 |
| 📝 Open Issues | 46 |
...
**Topics**：activemq, dubbo, kafka, rabbitmq, rocketmq, spring-boot, spring-cloud, spring-cloud-alibaba

**中文Topics**：活跃的MQ, 达博, kafka, rabbitmq, 火箭MQ, 弹簧靴, 春云, spring-cloud-阿里巴巴


---

### 144. PrefectHQ/fastmcp
...
### 146. jhipster/generator-jhipster

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/jhipster/generator-jhipster](https://github.com/jhipster/generator-jhipster) |
| ⭐ Stars | 22412 |
| 🍴 Forks | 4181 |
| 👀 Watchers | 22412 |
| 📝 Open Issues | 137 |
...
**Topics**：angular, cloud, docker, generator, hacktoberfest, java, jhipster, kubernetes, react, spring-boot, webpack, yeoman-generator
...
| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/modelcontextprotocol/python-sdk](https://github.com/modelcontextprotocol/python-sdk) |
| ⭐ Stars | 23256 |
| 🍴 Forks | 3509 |
| 👀 Watchers | 23256 |
| 📝 Open Issues | 538 |
...
**中文简介**：
用于模型上下文协议服务器和客户端的官方 Python SDK
...
### 148. parse-community/parse-server

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/parse-community/parse-server](https://github.com/parse-community/parse-server) |
| ⭐ Stars | 21399 |
| 🍴 Forks | 4823 |
| 👀 Watchers | 21399 |
| 📝 Open Issues | 497 |
...
**中文简介**：
Node.js / Express 的解析服务器


**Topics**：baas, backend, file-storage, graphql, graphql-api, graphql-relay, graphql-server, hacktoberfest, mbaas, mongodb, nodejs, notifications, object-storage, parse-platform, parse-server, postgres, relay, rest-api



---

### 149. yonggekkk/Cloudflare-vless-trojan

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/yonggekkk/Cloudflare-vless-trojan](https://github.com/yonggekkk/Cloudflare-vless-trojan) |
| ⭐ Stars | 15096 |
| 🍴 Forks | 9445 |
| 👀 Watchers | 15096 |
| 📝 Open Issues | 2 |
...
**中文简介**：
CF-workers/pages代理脚本：支持Vless-ws(tls)、Trojan-ws(tls)；Socks5/http本地代理脚本：可选ECH-TLS、普通TLS、无TLS透明代理模式


**Topics**：argo, cdn, clash-meta, cloudflare, cloudflare-pages, cloudflare-workers, ech, http, nat64, reality, sing-box, socks5, trojan, vless, xray, ygkkk



---

### 150. valkey-io/valkey
...
### 153. wistbean/learn_python3_spider

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/wistbean/learn_python3_spider](https://github.com/wistbean/learn_python3_spider) |
| ⭐ Stars | 21760 |
| 🍴 Forks | 3924 |
| 👀 Watchers | 21760 |
| 📝 Open Issues | 44 |
...
**中文Topics**：python脚本, 蟒蛇蜘蛛, 蟒蛇3


---

### 154. jaegertracing/jaeger
...
### 155. dockersamples/example-voting-app
...
### 156. neoclide/coc.nvim

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/neoclide/coc.nvim](https://github.com/neoclide/coc.nvim) |
| ⭐ Stars | 25155 |
| 🍴 Forks | 959 |
| 👀 Watchers | 25155 |
| 📝 Open Issues | 32 |
...
**中文简介**：
用于 vim 和 neovim 的 Nodejs 扩展主机，加载 VSCode 等扩展和主机语言服务器。


**Topics**：autocompletion, language-client, lsp, neovim-plugin, nvim, vim, vim-plugin

**中文Topics**：自动完成, 语言客户端, lsp, neovim 插件, 尼维姆, 维姆, vim 插件


---

### 157. nocobase/nocobase
...
**中文简介**：
NocoBase是一个开源AI+无代码平台，用于快速构建业务系统。人工智能不是从头开始生成所有内容，而是在经过生产验证的基础设施和所见即所得无代码界面之上工作，因此您可以获得速度和可靠性。
...
| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/websockets/ws](https://github.com/websockets/ws) |
| ⭐ Stars | 22770 |
| 🍴 Forks | 2553 |
| 👀 Watchers | 22770 |
| 📝 Open Issues | 5 |
...
**中文简介**：
使用简单、速度极快且经过彻底测试的 Node.js WebSocket 客户端和服务器
...
### 159. StreisandEffect/streisand

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/StreisandEffect/streisand](https://github.com/StreisandEffect/streisand) |
| ⭐ Stars | 23471 |
| 🍴 Forks | 1957 |
| 👀 Watchers | 23471 |
| 📝 Open Issues | 237 |
...
**中文简介**：
Streisand 设置一个新服务器，运行您选择的 WireGuard、OpenConnect、OpenSSH、OpenVPN、Shadowsocks、sslh、Stunnel 或 Tor 网桥。它还为所有这些服务生成自定义指令。运行结束时，您会收到一个包含说明的 HTML 文件，可以与朋友、家人和其他活动人士共享。


**Topics**：ansible, anyconnect, censorship, openconnect, openvpn, shadowsocks, ssh, streisand, stunnel, tor, vpn, wireguard



---

### 160. swagger-api/swagger-codegen
...
| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/apify/crawlee](https://github.com/apify/crawlee) |
| ⭐ Stars | 23687 |
| 🍴 Forks | 1421 |
| 👀 Watchers | 23687 |
| 📝 Open Issues | 170 |
...
**中文简介**：
Crawlee——一个用于 Node.js 的网络抓取和浏览器自动化库，用于构建可靠的爬虫。在 JavaScript 和 TypeScript 中。提取 AI、LLM、RAG 或 GPT 的数据。从网站下载 HTML、PDF、JPG、PNG 和其他文件。适用于 Puppeteer、Playwright、Cheerio、JSDOM 和原始 HTTP。有头模式和无头模式。通过代理轮换。
...
### 164. eclipse-theia/theia

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/eclipse-theia/theia](https://github.com/eclipse-theia/theia) |
| ⭐ Stars | 21551 |
| 🍴 Forks | 2838 |
| 👀 Watchers | 21551 |
| 📝 Open Issues | 1497 |
...
**中文简介**：
Eclipse Theia 是一个用 TypeScript 实现的云和桌面 IDE 框架。
...
### 165. YunaiV/yudao-cloud

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/YunaiV/yudao-cloud](https://github.com/YunaiV/yudao-cloud) |
| ⭐ Stars | 19056 |
| 🍴 Forks | 4758 |
| 👀 Watchers | 19056 |
| 📝 Open Issues | 2 |
...
**中文Topics**：达博, elasticsearch, 商场, mysql, 纳科斯, redis, 火箭MQ, 西塔, 分片领域, 空中漫步, 春云, spring-cloud-阿里巴巴, 弹簧靴, 春云, xxl-工作, 动物园管理员
...
| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/ceph/ceph](https://github.com/ceph/ceph) |
| ⭐ Stars | 16683 |
| 🍴 Forks | 6406 |
| 👀 Watchers | 16683 |
| 📝 Open Issues | 1115 |
...
**Topics**：block-storage, cloud-storage, distributed-file-system, distributed-storage, erasure-coding, fuse, hdfs, high-performance, highly-available, iscsi, kubernetes, nfs, nvme-over-fabrics, object-store, posix, replication, s3, smb, software-defined-storage, storage



---

### 167. qinguoyi/TinyWebServer

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/qinguoyi/TinyWebServer](https://github.com/qinguoyi/TinyWebServer) |
| ⭐ Stars | 19547 |
| 🍴 Forks | 4247 |
| 👀 Watchers | 19547 |
| 📝 Open Issues | 125 |
...
**Topics**：cpp, http-server, tinywebserver, webbench, webserver

**中文Topics**：cpp, http服务器, tinywebserver, webbench, web服务器


---

### 168. beekeeper-studio/beekeeper-studio

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/beekeeper-studio/beekeeper-studio](https://github.com/beekeeper-studio/beekeeper-studio) |
| ⭐ Stars | 22939 |
| 🍴 Forks | 1535 |
| 👀 Watchers | 22939 |
| 📝 Open Issues | 1101 |
...
**中文简介**：
适用于 MySQL、Postgres、SQLite、SQL Server 等的现代且易于使用的 SQL 客户端。 Linux、MacOS 和 Windows。
...
### 169. netbox-community/netbox

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/netbox-community/netbox](https://github.com/netbox-community/netbox) |
| ⭐ Stars | 20787 |
| 🍴 Forks | 3036 |
| 👀 Watchers | 20787 |
| 📝 Open Issues | 222 |
...
**中文简介**：
推动网络自动化的主要真相来源。在 Apache 2 下开源。免费试用 NetBox Cloud：https://netboxlabs.com/products/free-netbox-cloud/


**Topics**：cabling, dcim, django, infrastructure-management, ipam, netbox, network, network-automation, python, sot, sysadmin
...
| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/jina-ai/serve](https://github.com/jina-ai/serve) |
| ⭐ Stars | 21863 |
| 🍴 Forks | 2234 |
| 👀 Watchers | 21863 |
| 📝 Open Issues | 23 |
...
### 172. cloudflare/cloudflare-docs

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/cloudflare/cloudflare-docs](https://github.com/cloudflare/cloudflare-docs) |
| ⭐ Stars | 4801 |
| 🍴 Forks | 14833 |
| 👀 Watchers | 4801 |
| 📝 Open Issues | 385 |
...
### 173. adams549659584/go-proxy-bingai

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/adams549659584/go-proxy-bingai](https://github.com/adams549659584/go-proxy-bingai) |
| ⭐ Stars | 8518 |
| 🍴 Forks | 11989 |
| 👀 Watchers | 8518 |
| 📝 Open Issues | 217 |
...
### 176. nginx-proxy/nginx-proxy

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/nginx-proxy/nginx-proxy](https://github.com/nginx-proxy/nginx-proxy) |
| ⭐ Stars | 19851 |
| 🍴 Forks | 3051 |
| 👀 Watchers | 19851 |
| 📝 Open Issues | 332 |
...
### 177. lightgbm-org/LightGBM

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/lightgbm-org/LightGBM](https://github.com/lightgbm-org/LightGBM) |
| ⭐ Stars | 18429 |
| 🍴 Forks | 4023 |
| 👀 Watchers | 18429 |
| 📝 Open Issues | 508 |
...
**中文简介**：
基于决策树算法的快速、分布式、高性能梯度提升（GBT、GBDT、GBRT、GBM 或 MART）框架，用于排序、分类和许多其他机器学习任务。


**Topics**：data-mining, decision-trees, distributed, gbdt, gbm, gbrt, gradient-boosting, kaggle, lightgbm, machine-learning, microsoft, parallel, python, r
...
| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/QwenLM/Qwen](https://github.com/QwenLM/Qwen) |
| ⭐ Stars | 21250 |
| 🍴 Forks | 1824 |
| 👀 Watchers | 21250 |
| 📝 Open Issues | 44 |
...
### 181. neondatabase/neon

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/neondatabase/neon](https://github.com/neondatabase/neon) |
| ⭐ Stars | 22154 |
| 🍴 Forks | 982 |
| 👀 Watchers | 22154 |
| 📝 Open Issues | 539 |
...
**中文简介**：
Neon：无服务器 Postgres。我们将存储和计算分开，以提供自动扩展、类似代码的数据库分支以及扩展到零。
...
### 183. MatsuriDayo/NekoBoxForAndroid

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/MatsuriDayo/NekoBoxForAndroid](https://github.com/MatsuriDayo/NekoBoxForAndroid) |
| ⭐ Stars | 21205 |
| 🍴 Forks | 1678 |
| 👀 Watchers | 21205 |
| 📝 Open Issues | 158 |
...
**中文简介**：
NekoBox for Android / single-box / Android 通用代理工具链
...
### 184. cmliu/CF-Workers-docker.io

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/cmliu/CF-Workers-docker.io](https://github.com/cmliu/CF-Workers-docker.io) |
| ⭐ Stars | 9217 |
| 🍴 Forks | 10644 |
| 👀 Watchers | 9217 |
| 📝 Open Issues | 54 |
...
**中文Topics**：cloudflare 页面, cloudflare-workers, docker, dockerhub


---

### 185. chaitin/SafeLine
...
| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/knex/knex](https://github.com/knex/knex) |
| ⭐ Stars | 20286 |
| 🍴 Forks | 2198 |
| 👀 Watchers | 20286 |
| 📝 Open Issues | 717 |
...
**中文简介**：
适用于 PostgreSQL、MySQL、CockroachDB、SQL Server、SQLite3 和 Oracle 的查询构建器，设计灵活、可移植且使用起来有趣。


**Topics**：javascript, knex, mysql, postgresql, sql, sqlite3



---

### 187. microsoft/sql-server-samples

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/microsoft/sql-server-samples](https://github.com/microsoft/sql-server-samples) |
| ⭐ Stars | 11098 |
| 🍴 Forks | 9103 |
| 👀 Watchers | 11098 |
| 📝 Open Issues | 289 |
...
**中文简介**：
Azure 数据 SQL 示例 - 官方 Microsoft GitHub 存储库，包含 SQL Server、Azure SQL、Azure Synapse 和 Azure SQL Edge 的代码示例
...
| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/chenshuo/muduo](https://github.com/chenshuo/muduo) |
| ⭐ Stars | 16126 |
| 🍴 Forks | 5320 |
| 👀 Watchers | 16126 |
| 📝 Open Issues | 85 |
...
| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/saltstack/salt](https://github.com/saltstack/salt) |
| ⭐ Stars | 15477 |
| 🍴 Forks | 5592 |
| 👀 Watchers | 15477 |
| 📝 Open Issues | 2550 |
...
**中文简介**：
用于大规模自动化管理和配置基础设施和应用程序的软件。


**Topics**：cloud, cloud-management, cloud-providers, cloud-provisioning, configuration-management, edge, event-management, event-stream, infrastructure, infrastructure-as-a-code, infrastructure-as-code, infrastructure-automation, infrastructure-management, iot, python, remote-execution, zeromq



---

### 190. grpc-ecosystem/grpc-gateway
...
### 191. shadcn-ui/taxonomy

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/shadcn-ui/taxonomy](https://github.com/shadcn-ui/taxonomy) |
| ⭐ Stars | 19243 |
| 🍴 Forks | 2723 |
| 👀 Watchers | 19243 |
| 📝 Open Issues | 219 |
...
### 193. GoogleCloudPlatform/generative-ai
...
**中文简介**：
使用 Gemini Enterprise Agent Platform 在 Google Cloud 上进行生成式 AI 的示例代码和笔记本
...
### 194. anderspitman/awesome-tunneling

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/anderspitman/awesome-tunneling](https://github.com/anderspitman/awesome-tunneling) |
| ⭐ Stars | 21163 |
| 🍴 Forks | 1031 |
| 👀 Watchers | 21163 |
| 📝 Open Issues | 82 |
...
**中文简介**：
ngrok、Cloudflare Tunnel、Tailscale 和 ZeroTier 替代品以及其他隧道软件和服务的列表。专注于自托管。


**Topics**：nebula, ngrok, ngrok-alternative, self-hosted, ssh, tailscale, tailscale-alternative, tunnel-proxy, tunneling, zerotier



---

### 195. Grasscutters/Grasscutter

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/Grasscutters/Grasscutter](https://github.com/Grasscutters/Grasscutter) |
| ⭐ Stars | 16763 |
| 🍴 Forks | 4324 |
| 👀 Watchers | 16763 |
| 📝 Open Issues | 150 |
...
### 196. ZLMediaKit/ZLMediaKit

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/ZLMediaKit/ZLMediaKit](https://github.com/ZLMediaKit/ZLMediaKit) |
| ⭐ Stars | 17128 |
| 🍴 Forks | 4051 |
| 👀 Watchers | 17128 |
| 📝 Open Issues | 124 |
...
**中文简介**：
基于C++11的WebRTC/RTSP/RTMP/HTTP/HLS/HTTP-FLV/WebSocket-FLV/HTTP-TS/HTTP-fMP4/WebSocket-TS/WebSocket-fMP4/GB28181/SRT/STUN/TURN服务器和客户端框架


**Topics**：flv, gb28181, hls, http, http-flv, http-fmp4, http-ts, live, media-server, mp4, rtmp, rtp, rtsp, srt, stun, ts, turn, webrtc, websocket, websocket-flv



---

### 197. sqshq/piggymetrics

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/sqshq/piggymetrics](https://github.com/sqshq/piggymetrics) |
| ⭐ Stars | 13929 |
| 🍴 Forks | 6390 |
| 👀 Watchers | 13929 |
| 📝 Open Issues | 30 |
...
**中文简介**：
使用 Spring Boot、Spring Cloud 和 Docker 的微服务架构


**Topics**：docker, microservice, microservices, spring-boot, spring-cloud



---

### 198. nats-io/nats-server
...
### 199. TGSAN/CMWTAT_Digital_Edition
...
[← 上一页](infrastructure-01.md)
 | 
[下一页 →](infrastructure-03.md)
