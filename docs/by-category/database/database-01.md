...
**中文简介**：
Linux、Jenkins、AWS、SRE、Prometheus、Docker、Python、Ansible、Git、Kubernetes、Terraform、OpenStack、SQL、NoSQL、Azure、GCP、DNS、Elastic、Network、Virtualization。DevOps 面试题。
...
**中文Topics**：ansible, aws, azure, coding, containers, devops, docker, git, 面试, interview-questions, kubernetes, linux, openstack, production-engineer, prometheus, python, sql, sre, terraform
...
### 15. fastapi/full-stack-fastapi-template
...
### 28. qishibo/AnotherRedisDesktopManager
...
| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/mongodb/mongo](https://github.com/mongodb/mongo) |
| ⭐ Stars | 28342 |
| 🍴 Forks | 5779 |
| 👀 Watchers | 28342 |
| 📝 Open Issues | 26 |
...
**中文简介**：
具有缓存支持的异步图像下载器作为 UIImageView 类别


**Topics**：cache, carthage, cocoapods, gif, heif, image, ios, jpeg, macos, objective-c, png, sdwebimage, swift, visionos, watchos, webp



---

### 37. Automattic/mongoose

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/Automattic/mongoose](https://github.com/Automattic/mongoose) |
| ⭐ Stars | 27486 |
| 🍴 Forks | 3993 |
| 👀 Watchers | 27486 |
| 📝 Open Issues | 181 |
...
### 38. dragonflydb/dragonfly

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/dragonflydb/dragonfly](https://github.com/dragonflydb/dragonfly) |
| ⭐ Stars | 30611 |
| 🍴 Forks | 1183 |
| 👀 Watchers | 30611 |
| 📝 Open Issues | 294 |
...
**Topics**：cache, cpp, database, fibers, in-memory, in-memory-database, key-value, keydb, memcached, message-broker, multi-threading, nosql, redis, valkey, vector-search
...
### 43. rethinkdb/rethinkdb

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/rethinkdb/rethinkdb](https://github.com/rethinkdb/rethinkdb) |
| ⭐ Stars | 26999 |
| 🍴 Forks | 1854 |
| 👀 Watchers | 26999 |
| 📝 Open Issues | 1352 |
...
### 45. PostgREST/postgrest

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/PostgREST/postgrest](https://github.com/PostgREST/postgrest) |
| ⭐ Stars | 27203 |
| 🍴 Forks | 1199 |
| 👀 Watchers | 27203 |
| 📝 Open Issues | 379 |
...
**中文简介**：
OpenViking是一个专门为AI Agent（例如openclaw）设计的开源上下文数据库。 OpenViking 通过文件系统范例统一了代理所需的上下文（内存、资源和技能）管理，从而实现了分层上下文交付和自我演化。
...
### 51. redis/RedisDesktopManager

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/redis/RedisDesktopManager](https://github.com/redis/RedisDesktopManager) |
| ⭐ Stars | 23234 |
| 🍴 Forks | 3242 |
| 👀 Watchers | 23234 |
| 📝 Open Issues | 68 |
...
### 52. localForage/localForage

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/localForage/localForage](https://github.com/localForage/localForage) |
| ⭐ Stars | 25782 |
| 🍴 Forks | 1294 |
| 👀 Watchers | 25782 |
| 📝 Open Issues | 249 |
...
**中文简介**：
💾 离线存储，已改进。使用简单但功能强大的 API 包装 IndexedDB、WebSQL 或 localStorage。
...
### 53. sqlitebrowser/sqlitebrowser

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/sqlitebrowser/sqlitebrowser](https://github.com/sqlitebrowser/sqlitebrowser) |
| ⭐ Stars | 24122 |
| 🍴 Forks | 2342 |
| 👀 Watchers | 24122 |
| 📝 Open Issues | 831 |
...
**中文简介**：
DB Browser for SQLite (DB4S) 项目的官方主页。以前称为“SQLite 数据库浏览器”和“SQLite 数据库浏览器”。网站位于：
...
### 54. typesense/typesense

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/typesense/typesense](https://github.com/typesense/typesense) |
| ⭐ Stars | 25950 |
| 🍴 Forks | 893 |
| 👀 Watchers | 25950 |
| 📝 Open Issues | 814 |
...
**中文简介**：
Algolia + Pinecone 的开源替代方案以及 ElasticSearch 的更易于使用的替代方案 ⚡ 🔍 ✨ 快速、容错、内存中模糊搜索引擎，用于构建令人愉悦的搜索体验
...
### 56. wistbean/learn_python3_spider
...
**中文简介**：
🤖 与您的 SQL 数据库聊天 📊。使用代理检索通过LLM准确生成文本到 SQL。
...
| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/osquery/osquery](https://github.com/osquery/osquery) |
| ⭐ Stars | 23288 |
| 🍴 Forks | 2571 |
| 👀 Watchers | 23288 |
| 📝 Open Issues | 615 |
...
### 61. beekeeper-studio/beekeeper-studio
...
| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/pubkey/rxdb](https://github.com/pubkey/rxdb) |
| ⭐ Stars | 23218 |
| 🍴 Forks | 1163 |
| 👀 Watchers | 23218 |
| 📝 Open Issues | 14 |
...
**中文简介**：
用于 JavaScript 应用程序的快速、本地优先、反应式数据库 https://rxdb.info/
...
### 63. macrozheng/mall-learning

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/macrozheng/mall-learning](https://github.com/macrozheng/mall-learning) |
| ⭐ Stars | 13378 |
| 🍴 Forks | 8286 |
| 👀 Watchers | 13378 |
| 📝 Open Issues | 5 |
...
**Topics**：docker, elasticsearch, mongodb, mybatis, mysql, rabbitmq, redis, springboot, springcloud

**中文Topics**：docker, elasticsearch, mongodb, 我的鞋, mysql, rabbitmq, redis, 弹簧靴, 春云


---

### 64. timescale/timescaledb
...
| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/Seldaek/monolog](https://github.com/Seldaek/monolog) |
| ⭐ Stars | 21388 |
| 🍴 Forks | 1906 |
| 👀 Watchers | 21388 |
| 📝 Open Issues | 26 |
...
**中文简介**：
将日志发送到文件、套接字、收件箱、数据库和各种 Web 服务


**Topics**：hacktoberfest, logger, logging, php, psr-3
...
| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/typicode/lowdb](https://github.com/typicode/lowdb) |
| ⭐ Stars | 22547 |
| 🍴 Forks | 965 |
| 👀 Watchers | 22547 |
| 📝 Open Issues | 15 |
...
**Topics**：database, electron, embeddable, embedded-database, javascript, json, localstorage, lodash, nodejs, storage
...
### 74. microsoft/sql-server-samples
...
### 75. marimo-team/marimo

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/marimo-team/marimo](https://github.com/marimo-team/marimo) |
| ⭐ Stars | 21324 |
| 🍴 Forks | 1126 |
| 👀 Watchers | 21324 |
| 📝 Open Issues | 633 |
...
**Topics**：artificial-intelligence, dag, data-science, data-visualization, dataflow, developer-tools, machine-learning, notebooks, pipeline, python, reactive, sql, web-app



---

### 76. Dujltqzv/Some-Many-Books
...
### 77. valeriansaliou/sonic

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/valeriansaliou/sonic](https://github.com/valeriansaliou/sonic) |
| ⭐ Stars | 21243 |
| 🍴 Forks | 615 |
| 👀 Watchers | 21243 |
| 📝 Open Issues | 71 |
...
**中文简介**：
🦔 快速、轻量级且无模式的搜索后端。 Elasticsearch 的替代方案，在几 MB RAM 上运行。


**Topics**：backend, database, graph, index, infrastructure, rust, search, search-engine, search-server, server
...
| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/mysqljs/mysql](https://github.com/mysqljs/mysql) |
| ⭐ Stars | 18626 |
| 🍴 Forks | 2518 |
| 👀 Watchers | 18626 |
| 📝 Open Issues | 175 |
...
**中文简介**：
实现 MySQL 协议的纯 Node.js JavaScript 客户端。
...
| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/ty4z2008/Qix](https://github.com/ty4z2008/Qix) |
| ⭐ Stars | 15131 |
| 🍴 Forks | 4591 |
| 👀 Watchers | 15131 |
| 📝 Open Issues | 0 |
...
**中文简介**：
Sealos 是一个基于 Kubernetes 构建的人工智能原生云操作系统，它统一了从云 IDE 中的开发到生产部署和管理的整个应用程序生命周期。它非常适合构建和扩展现代人工智能应用程序、托管数据库（MySQL、PostgreSQL、Redis、MongoDB）和复杂的微服务架构。
...
| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/apache/doris](https://github.com/apache/doris) |
| ⭐ Stars | 15438 |
| 🍴 Forks | 3813 |
| 👀 Watchers | 15438 |
| 📝 Open Issues | 1020 |
...
**Topics**：agent, ai, bigquery, database, dbt, delta-lake, hudi, iceberg, lakehouse, observability, olap, paimon, query-engine, real-time, redshift, snowflake, spark, sql



---

### 85. tursodatabase/turso
...
**中文简介**：
Turso 是一个进程内 SQL 数据库，与 SQLite 兼容。
...
### 90. zhisheng17/flink-learning

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/zhisheng17/flink-learning](https://github.com/zhisheng17/flink-learning) |
| ⭐ Stars | 15061 |
| 🍴 Forks | 3943 |
| 👀 Watchers | 15061 |
| 📝 Open Issues | 4 |
...
**Topics**：clickhouse, elasticsearch, flink, hbase, influxdb, kafka, loki, mysql, opentsdb, rabbitmq, redis, rocketmq, spark, stream-processing, streaming

**中文Topics**：点击屋, elasticsearch, 大量, 数据库, 流入数据库, kafka, loki, mysql, 开放式数据库, rabbitmq, redis, 火箭MQ, 火花, 流处理, 流媒体
...
| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/redis/node-redis](https://github.com/redis/node-redis) |
| ⭐ Stars | 17538 |
| 🍴 Forks | 1957 |
| 👀 Watchers | 17538 |
| 📝 Open Issues | 243 |
...
| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/tikv/tikv](https://github.com/tikv/tikv) |
| ⭐ Stars | 16709 |
| 🍴 Forks | 2283 |
| 👀 Watchers | 16709 |
| 📝 Open Issues | 1733 |
...
**Topics**：cncf, consensus, distributed-transactions, hacktoberfest, key-value, raft, rocksdb, rust, tidb, tikv



---

### 93. janeczku/calibre-web

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/janeczku/calibre-web](https://github.com/janeczku/calibre-web) |
| ⭐ Stars | 17395 |
| 🍴 Forks | 1789 |
| 👀 Watchers | 17395 |
| 📝 Open Issues | 405 |
...
**中文简介**：
:books：用于浏览、阅读和下载存储在 Calibre 数据库中的电子书的 Web 应用程序


**Topics**：calibre, ebook, ebook-manager, epub, mobi



---

### 94. realm/realm-swift

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/realm/realm-swift](https://github.com/realm/realm-swift) |
| ⭐ Stars | 16607 |
| 🍴 Forks | 2223 |
| 👀 Watchers | 16607 |
| 📝 Open Issues | 495 |
...
**中文简介**：
Realm 是一个移动数据库：Core Data 和 SQLite 的替代品


**Topics**：database, ios, mobile, mobile-database, objective-c, realtime, swift, sync, threadsafe
...
| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/apache/pouchdb](https://github.com/apache/pouchdb) |
| ⭐ Stars | 17576 |
| 🍴 Forks | 1505 |
| 👀 Watchers | 17576 |
| 📝 Open Issues | 174 |
...
### 96. VictoriaMetrics/VictoriaMetrics
...
| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/transact-rs/sqlx](https://github.com/transact-rs/sqlx) |
| ⭐ Stars | 17102 |
| 🍴 Forks | 1621 |
| 👀 Watchers | 17102 |
| 📝 Open Issues | 741 |
...
**中文简介**：
🧰 Rust SQL 工具包。一个异步、纯 Rust SQL 包，具有​​编译时检查查询功能，无需 DSL。支持 PostgreSQL、MySQL 和 SQLite。
