...
**中文简介**：
列出对 DevOps 和基础设施开发者有吸引力的免费层级的 SaaS、PaaS 和 IaaS 服务。


**Topics**：awesome-list, free-for-developers

**中文Topics**：精选列表, 开发者免费资源
...
**中文简介**：
⭐AI 驱动的舆情与趋势监控工具，支持多平台聚合、RSS 与智能告警。🎯 告别信息过载，你的 AI 舆情监控助手与热点筛选工具！聚合多平台热点 + RSS 订阅，支持关键词精准筛选。AI 智能筛选新闻 + AI 翻译 + AI 分析简报直推手机，也支持接入 MCP 架构，赋能 AI 自然语言对话分析、情感洞察与趋势预测等。支持 Docker，数据本地/云端自持。集成微信/飞书/钉钉/Telegram/邮件/ntfy/bark/slack 等渠道智能推送。


**Topics**：ai, bark, data-analysis, docker, hot-news, llm, mail, mcp, mcp-server, news, ntfy, python, rss, trending-topics, wechat, wework

**中文Topics**：ai, bark, 数据分析, docker, 热点新闻, llm, 邮件, mcp, mcp-server, 新闻, ntfy, python, rss, 热门话题, 微信, 企业微信
...
### 12. kelseyhightower/kubernetes-the-hard-way

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/kelseyhightower/kubernetes-the-hard-way](https://github.com/kelseyhightower/kubernetes-the-hard-way) |
| ⭐ Stars | 48541 |
| 🍴 Forks | 15694 |
| 👀 Watchers | 48541 |
| 📝 Open Issues | 49 |
...
### 23. fastapi/full-stack-fastapi-template
...
### 35. PDFMathTranslate/PDFMathTranslate
...
### 37. NginxProxyManager/nginx-proxy-manager
...
### 39. dotnet-architecture/eShopOnContainers
...
### 46. iam-veeramalla/Jenkins-Zero-To-Hero
...
### 48. dgtlmoon/changedetection.io
...
### 51. GoogleCloudPlatform/microservices-demo
...
### 58. iam-veeramalla/aws-devops-zero-to-hero
...
### 60. enescingoz/awesome-n8n-templates
...
**中文简介**：
280 多个免费的 n8n 自动化模板 — 适用于 Gmail、Telegram、Slack、Discord、WhatsApp、Google Drive、Notion、OpenAI 等的即用型工作流程。 AI 代理、RAG 聊天机器人、电子邮件自动化、社交媒体、DevOps 和文档处理。最大的开源 n8n 模板集合。
...
### 63. wsargent/docker-cheat-sheet

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/wsargent/docker-cheat-sheet](https://github.com/wsargent/docker-cheat-sheet) |
| ⭐ Stars | 22525 |
| 🍴 Forks | 4613 |
| 👀 Watchers | 22525 |
| 📝 Open Issues | 7 |
...
### 67. eip-work/kuboard-press

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/eip-work/kuboard-press](https://github.com/eip-work/kuboard-press) |
| ⭐ Stars | 25021 |
| 🍴 Forks | 1601 |
| 👀 Watchers | 25021 |
| 📝 Open Issues | 521 |
...
**Topics**：docker, k8s, kubernetes, kubernetes-kuboard

**中文Topics**：docker, k8s, kubernetes, kubernetes-kuboard
...
| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/vulhub/vulhub](https://github.com/vulhub/vulhub) |
| ⭐ Stars | 20789 |
| 🍴 Forks | 4777 |
| 👀 Watchers | 20789 |
| 📝 Open Issues | 52 |
...
### 69. dockersamples/example-voting-app
...
| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/mlc-ai/mlc-llm](https://github.com/mlc-ai/mlc-llm) |
| ⭐ Stars | 22766 |
| 🍴 Forks | 2060 |
| 👀 Watchers | 22766 |
| 📝 Open Issues | 313 |
...
### 75. iam-veeramalla/Docker-Zero-to-Hero
...
| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/lensapp/lens](https://github.com/lensapp/lens) |
| ⭐ Stars | 23174 |
| 🍴 Forks | 1486 |
| 👀 Watchers | 23174 |
| 📝 Open Issues | 1186 |
...
| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/Delgan/loguru](https://github.com/Delgan/loguru) |
| ⭐ Stars | 23945 |
| 🍴 Forks | 797 |
| 👀 Watchers | 23945 |
| 📝 Open Issues | 252 |
...
**中文简介**：
一个具有一体化可视化工具的 AI 代理开发平台，以前所未有的方式简化代理创建、调试和部署。轻松创建 AI 代理。
...
### 80. hashicorp/terraform-provider-aws
...
### 81. GoogleContainerTools/distroless

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/GoogleContainerTools/distroless](https://github.com/GoogleContainerTools/distroless) |
| ⭐ Stars | 22701 |
| 🍴 Forks | 1398 |
| 👀 Watchers | 22701 |
| 📝 Open Issues | 14 |
...
### 85. NirDiamant/agents-towards-production
...
**中文简介**：
用于构建生产级 GenAI 代理的端到端、代码优先教程。从原型到企业部署。
...
### 86. milanm/DevOps-Roadmap

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/milanm/DevOps-Roadmap](https://github.com/milanm/DevOps-Roadmap) |
| ⭐ Stars | 19562 |
| 🍴 Forks | 3387 |
| 👀 Watchers | 19562 |
| 📝 Open Issues | 9 |
...
**中文简介**：
2026 年 DevOps 路线图。包含学习资源


**Topics**：aws, azure, computer-science, continous-delivery, continuous-integration, developer-roadmap, devops, devops-roadmap, docker, go, grafana, jira, kubernetes, linux, prometheus, python, roadmap, sre, study-plan



---

### 87. nginx-proxy/nginx-proxy
...
### 90. kodekloudhub/certified-kubernetes-administrator-course
...
### 100. actions/starter-workflows

| 属性 | 信息 |
|---|---|
| 链接 | [https://github.com/actions/starter-workflows](https://github.com/actions/starter-workflows) |
| ⭐ Stars | 11672 |
| 🍴 Forks | 7081 |
| 👀 Watchers | 11672 |
| 📝 Open Issues | 459 |
